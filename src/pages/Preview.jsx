...
export default function Preview() {
  ...
  if (!resumeData)
    return <p className="text-center mt-10">No Resume Data Found.</p>;

  return (
    <div>
      <div
        ref={resumeRef}
        className="max-w-2xl mx-auto p-8 bg-white shadow-lg m-5 border rounded-lg"
      >
        {/* Header Section */}
        ...
        {resumeData.experience ? (
          <>
            <p className="text-gray-700">
              <strong>{resumeData.experience.company}</strong> (
      ...
      <div className="flex justify-center">
        <button
          onClick={handlePrint}
          className="bg-violet-800 text-white p-3 rounded-lg hover:bg-violet-950 transition m-4"
        >
          Download as PDF
        </button>
        <button
